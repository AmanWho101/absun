        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-12 my-3">
                ...
                <form class="contact" id="contact" action="{{ route('contact') }}" method="POST">
                    ...
                    <div class="form-group">
                        <textarea name="contact-msg" class="form-control input-lg" rows="6" placeholder="Your comment" required></textarea>
                    </div>
            ...
            <div class="col-md-6 col-sm-6 my-3">
                ...
                {{--                <div class="media media-top">
                    ...
                    <div class="media-body ml-3">
                        ...
                        <address>
                            Careers with AB Sun General Consultancy is a rapidly growing company and is always looking for
                            individuals and group expertise for consultant positions.
                ...
                <div class="media-body ml-3">
                    <ul class="list-unstyled" style="font-weight: 600;   font-size: 70px;">
                        <li class="mb-2 " style=" font-size: 18px;">Careers with AB Sun General Consultancy is a rapidly
                            growing company and is
                            always looking for individuals and group expertise for consultant positions. </li>
                        <li style=" font-size: 16px;">

                            <i class="livicon icon4 icon3 lead" data-name="cellphone" data-size="18" data-loop="true"
                                data-c="#ccc" data-hc="#ccc"></i> Phone: +251 9140 123 4588
                        </li>
                        ...
                        <li style=" font-size: 16px;">
                            <i class="livicon icon3 " data-name="mail-alt" data-size="20" data-loop="true" data-c="#ccc"
                                data-hc="#ccc"></i>
                            Email: <a class="text-success" href="mailto:absun@gmail.com">absun@gmail.com</a>
                        </li>
