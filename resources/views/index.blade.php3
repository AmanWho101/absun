...
@section('header_styles')
 ...
 --}}
    ...
    <link rel="stylesheet" href=" {{ asset('css/landingpage/slicknav.css') }}">

    <link rel="stylesheet" href=" {{ asset('css/landingpage/flaticon.css') }}">
    ...
    <link rel="stylesheet" href=" {{ asset('css/landingpage/fontawesome-all.min.css') }}">

    <link rel="stylesheet" href=" {{ asset('css/landingpage/themify-icons.css') }}">

    <link rel="stylesheet" href=" {{ asset('css/landingpage/slick.css') }}">
...
@section('top')
    <!--Carousel Start -->
    <div id="owl-demo" class="container">

        <div class="slider-area  ">
            <div class="slider-active slick-initialized slick-slider"><button type="button" class="slick-prev slick-arrow"
                    style="display: block;">
                    <i class="ti-arrow-left"></i></button>
                <!-- Single Slider -->

                <div class="slick-list draggable">
                    <div class="slick-track" style="opacity: 1; width: 2764px;">
                        <div class="single-slider slider-height d-flex align-items-center slick-slide slick-current slick-active"
                            data-slick-index="0" aria-hidden="false" tabindex="0"
                            style="width: 1382px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-8 col-lg-7 col-md-8">
                                        <div class="hero__caption">
                                            <span data-animation="fadeInLeft" data-delay=".1s" class=""
                                                style="animation-delay: 0.1s;">Committed to success</span>
                                            <h1 data-animation="fadeInLeft" data-delay=".5s" class=""
                                                style="animation-delay: 0.5s;">We help to grow your business</h1>
                                            <p data-animation="fadeInLeft" data-delay=".9s" class=""
                                                style="animation-delay: 0.9s;">Mollit anim laborum.Dvcuis aute serunt
                                                iruxvfg dhjkolohr indd re voluptate<br> velit esscillumlore eu quife nrulla
                                                parihatur.
                                            </p>
                                            <!-- Hero-btn -->
                                            <div class="hero__btn" data-animation="fadeInLeft" data-delay="1.1s"
                                                style="animation-delay: 1.1s;">
                                                <a href="industries.html" class="btn hero-btn" tabindex="0">Our
                                                    Services</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="single-slider slider-height d-flex align-items-center slick-slide" data-slick-index="1"
                            aria-hidden="true" tabindex="-1"
                            style="width: 1382px; position: relative; left: -1382px; top: 0px; z-index: 998; opacity: 0;">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-8 col-lg-7 col-md-8">
                                        <div class="hero__caption">
                                            <span data-animation="fadeInLeft" data-delay=".1s">Committed to success</span>
                                            <h1 data-animation="fadeInLeft" data-delay=".5s">We help to grow your business
                                            </h1>
                                            <p data-animation="fadeInLeft" data-delay=".9s">Mollit anim laborum.Dvcuis aute
                                                serunt iruxvfg dhjkolohr indd re voluptate<br> velit esscillumlore eu quife
                                                nrulla parihatur.</p>
                                            <!-- Hero-btn -->
                                            <div class="hero__btn" data-animation="fadeInLeft" data-delay="1.1s">
                                                <a href="industries.html" class="btn hero-btn" tabindex="-1">Our
                                                    Services</a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container bg-border wow pulse" data-wow-duration="2.5s">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12 col-12 col-lg-4"><a href="#"
                            class="btn purchase-styl float-lg-right">Purchase now</a></div>
                </div>
            </div>
        </section>
...
@section('footer_scripts')
    ...
    <!-- new lading page js starts-->

    <!-- JS here -->

    <script type="text/javascript" src="{{ asset('css/landingpage/js/vendor/modernizr-3.5.0.min.js ') }}"></script>
    <!-- Jquery, Popper, Bootstrap -->
    <script src=" {{ asset('css/landingpage/js/vendor/jquery-1.12.4.min.js ') }}"></script>
    <script src=" {{ asset('css/landingpage/js/popper.min.js ') }}"></script>

    <script src=" {{ asset('css/landingpage/js/bootstrap.min.js ') }}"></script>
    <!-- Jquery Mobile Menu -->
    <script src=" {{ asset('css/landingpage/js/jquery.slicknav.min.js') }} "></script>

    <!-- Jquery Slick , Owl-Carousel Plugins -->
    <script src=" {{ asset('css/landingpage/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('css/landingpage/js/slick.min.js') }}"></script>

    <!-- One Page, Animated-HeadLin -->
    <script src="{{ asset('css/landingpage/js/wow.min.js') }}"></script>
    <script src="{{ asset('css/landingpage/js/animated.headline.js') }}"></script>
    <script src="{{ asset('css/landingpage/js/jquery.magnific-popup.js') }}"></script>

    <!-- Nice-select, sticky -->
    <script src="{{ asset('css/landingpage/js/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('css/landingpage/js/jquery.sticky.js') }}"></script>

    <!-- counter , waypoint -->
    <script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script>
    <script src=" {{ asset('css/landingpage/js/jquery.counterup.min.js') }}"></script>

    <!-- contact js -->
    <script src="{{ asset('css/landingpage/js/contact.js') }}  "></script>
    <script src=" {{ asset('css/landingpage/js/jquery.form.js') }} "></script>
    <script src="  {{ asset('css/landingpage/js/jquery.validate.min.js') }}"></script>
    <script src=" {{ asset('css/landingpage/js/mail-script.js') }}"></script>
    <script src=" {{ asset('css/landingpage/js/jquery.ajaxchimp.min.js') }}"></script>

    <!-- Jquery Plugins, main Jquery -->
    <script src=" {{ asset('css/landingpage/js/plugins.js') }} "></script>
    <script src=" {{ asset('css/landingpage/js/main.js') }}  "></script>

    <!--end of landing page js -->
